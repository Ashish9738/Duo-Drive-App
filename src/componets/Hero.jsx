    ...
    <div className="hero-section">
      <div className="hero-content">
        <img
          ...
          alt="Logo"
        />
        <h1 className="hero-title">Welcome to Duo Driver</h1>
        <p className="hero-description">
          Pair AI Learner: Elevate your learning journey with the power of
          personalized AI guidance. Experience seamless collaboration as your AI
          partner adapts to your unique needs, providing targeted feedback and
          insights to accelerate your progress. Unlock your full potential,
          learn faster, and achieve your goals with the perfect learning
